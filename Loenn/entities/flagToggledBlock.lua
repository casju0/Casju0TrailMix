...
local flagToggledBlock = {}

local depth = -10

flagToggledBlock.name = "Casju0TrailMix/FlagToggledBlock"
flagToggledBlock.warnBelowSize = { 16, 16 }

flagToggledBlock.fieldInformation = {
   index = {
      fieldType = "integer",
   },
   activeColor = {
...
flagToggledBlock.placements = { {
   name = "flag_toggled_block_pink",
   data = {
      index = 0,
      width = 16,
      height = 16,
      ...
      inverted = true,
      activeColor = "f80080",
      inactiveColor = "f80080",
      activeTexture = "objects/Casju0TrailMix/flagToggledBlock/on",
      inactiveTexture = "objects/Casju0TrailMix/flagToggledBlock/off",
   },
}, {
   name = "flag_toggled_block_blue",
   data = {
      index = 1,
      width = 16,
      height = 16,
      ...
      inverted = false,
      activeColor = "8080c8",
      inactiveColor = "8080c8",
      activeTexture = "objects/Casju0TrailMix/flagToggledBlock/on",
      inactiveTexture = "objects/Casju0TrailMix/flagToggledBlock/off",
   },
} }
-- filter by flag toggled blocks sharing the same index
...
function flagToggledBlock.sprite(room, entity)
   ...
   local color = entity.inactiveColor
   if entity.inverted then
      color = entity.activeColor
   end

   local texture = entity.inactiveTexture
   if entity.inverted then
      texture = entity.activeTexture
   end

   for x = 1, tileWidth do
      for y = 1, tileHeight do
         local sprite = getTileSprite(entity, x, y, texture, color, depth, rectangles)
